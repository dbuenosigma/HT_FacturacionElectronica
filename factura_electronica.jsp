	    ...
	    for (int i=0; i<d_items.size(); i++)
            {
                ...
                Item itemFE = new Item(
                      ...
                      , cdoI.getColValue("PrecioItem") //String precioItem Precio del 韙em. Si el 韙em no es valorable: informar campo en 0.00 PrecioItem <> Cantidad * (PrecioUnitario - PrecioUnitarioDescuento)
